...
#  QUERY
CREATE
DATABASE IF NOT EXISTS MessageDB;
USE
MessageDB;
#
QUERY
...
#
QUERY
# ROLLBACK IF IT FAILS -> WILL NOT CREATE
...
SELECT MessageId,
       ...
       Subject,
       Content
FROM Messages;ssages
(FromUserId, ToUserId, Subject, Content)
VALUES (1, 3, 'from user 1 to 3', 'This is the text content.'),
       (2, 99, 'from user 2 to 4', 'This is the text content between the two users 2 and 4');
#     text values NOT with " (double quotes) but
#                     with ' (single quotes)
# UPDATE RECORDS | ROWS
UPDATE Messages
